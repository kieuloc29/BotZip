...
"https://i.imgur.com/nfWKOFk.jpg",
 ...
 "https://i.imgur.com/FVkLWGP.jpg",
  ...
  var money = data.money
      if(money < 40000) api.sendMessage("Đéo có tiền đòi xem cái lồn, kiếm đủ 40000 đô rồi xem, oke ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 40000})
   var callback = () => api.sendMessage({body:`Bổ mắt nhé😼\n» Số dư: -40000 đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
